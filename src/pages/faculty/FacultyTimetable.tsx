...
export default function FacultyTimetable() {
  ...
  const addEntry = async () => {
    ...
    try {
      ...
      if (existing) {
        toast({ title: 'Slot occupied', description: 'This time slot already has an entry.', variant: 'destructive' });
        setSaving(false);
        return;
      }
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              {isTutor ? 'Manage your section timetable' : 'Your weekly class schedule'}
            </p>
          </div>
          {isTutor && (
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                No timetable entries found. {isTutor ? 'Click "Add Entry" to configure the schedule.' : 'The tutor will configure your schedule.'}
              </div>
            ) : (
                                ...
                                <div className="space-y-1">
                                  ...
                                  {isTutor && (
                                    <Button
                                      ...
                                      className="absolute top-0 right-0 h-6 w-6 opacity-0 group-hover:opacity-100 text-destructive"
